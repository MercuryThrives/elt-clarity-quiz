...
const CONTACT_EMAIL = 'Dave' + '@' + 'ElderLifeTransitions.net';
...
const PAGE_CONFIG = {
  hero: {
    ...
    h1b: "Find Out What It Would Take to Add Years to That Number.",
    qualifiers: [
    ...
    <div style={{ background: '#EDE8DC', minHeight: '100vh', fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <div style={sect('#EDE8DC', '52px 0 48px')}>
        <div style={W}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 'clamp(24px, 5vw, 38px)', fontWeight: 700, color: '#5D0E0E', lineHeight: 1.25, marginBottom: 18 }}>
            ...
            <br />
            <span style={{ color: '#3D3025' }}>{PAGE_CONFIG.hero.h1b}</span>
          </h1>
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 24px' }}>
            {PAGE_CONFIG.hero.qualifiers.map((q, i) => (
              <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 10, fontSize: 14, color: '#3D3025', lineHeight: 1.55 }}>
      ...
      <div id="brochure-story" style={sect('#fff')}>
        <div style={W}>
          ...
          <p style={bodyStyle}>
            Most families don't figure this out until they're two or three years in. By then, the options aren't just financial. They involve moving a loved one who has already found her footing somewhere.
          </p>
          <p style={{ ...bodyStyle, marginBottom: 0 }}>
            A chair she's claimed by a window. A nurse whose name she knows. Most families are trying to make sure they never have to have that conversation.
          </p>
        </div>
      </div>
      ...
      <div style={sect('#EDE8DC')}>
        <div style={W}>
          ...
          <p style={bodyStyle}>
            This calculator models one care path: assisted living in Colorado. It runs your loved one's approximate assets and income against what assisted living in your area actually costs, not just the rate communities quote on the tour, but the all-in number after the first care assessment, which is almost always higher.
          </p>
          <p style={bodyStyle}>
            Annual escalation is built in at 4.5%, based on West Region senior care cost trend data. Real-world increases in Colorado have often run significantly higher. The 4.5% figure is a planning baseline, not a ceiling.
          </p>
          <p style={bodyStyle}>
        ...
        <div style={sect('#fff')}>
          <div style={W}>
            ...
            <p style={{ ...mutedStyle, margin: 0 }}>
              David Johnstone · 720-258-6001 · {CONTACT_EMAIL}
            </p>
          </div>
        </div>
        ...
        <div style={sect('#3D3025', '56px 0')}>
          <div style={W}>
            ...
            <p style={{ ...mutedStyle, color: 'rgba(255,255,255,0.35)', textAlign: 'center', fontSize: 11, lineHeight: 1.7 }}>
              Elder Life Transitions · David Johnstone · 720-258-6001 · {CONTACT_EMAIL} · elderlifetransitions.net
              <br />
