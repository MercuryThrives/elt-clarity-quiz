...
export const SNF_PATHWAY_CONTENT: Record<SnfPathway, SnfPathwayContent> = {
  'assisted-living': {
    ...
    whatFamiliesDontKnow:
      'Most assisted living communities charge a base monthly rate plus a care level add-on that increases as your loved one\'s needs change — sometimes significantly. Understanding how that pricing escalates over time, and what triggers a care level increase, is one of the most important things to negotiate before signing. ELT reviews contracts with families before any commitment is made.',
    secondaryPathway:
  ...
  'memory-care': {
    ...
    whatFamiliesDontKnow:
      'Many families assume memory care is only appropriate for late-stage dementia. In reality, earlier placement often produces significantly better outcomes — residents adjust more easily, form stronger social connections, and experience less behavioral disturbance when they move before the disease progresses too far. The families who tell us they wish they had moved sooner are more common than those who feel they moved too early. ELT can help you assess where your loved one is in that window.',
    secondaryPathway:
