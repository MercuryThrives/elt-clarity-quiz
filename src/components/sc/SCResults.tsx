    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="rounded-2xl border-2 border-amber-200 bg-amber-50 px-6 py-6 mb-8">
        ...
        <ul className="space-y-3">
          {[
            "[Anticipation bullet 1 -- add in Prompt 7]",
            "[Anticipation bullet 2 -- add in Prompt 7]",
            "[Anticipation bullet 3 -- add in Prompt 7]",
          ].map((bullet, i) => (
        ...
        <>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-stone-100 bg-white px-5 py-5">
              ...
              <p className="text-[17px] text-stone-500 leading-relaxed italic">
                [Pathway description -- add in Prompt 7]
              </p>
            </div>
              ...
              <ul className="space-y-4">
                {[1, 2, 3].map((n) => (
                  <li key={n} className="flex gap-3">
                    <span className="mt-2 shrink-0 w-1.5 h-1.5 rounded-full bg-amber-400" />
                    <p className="text-[17px] text-stone-500 leading-relaxed italic">
                      [Anticipation bullet {n} -- add in Prompt 7]
                    </p>
                  </li>
                ))}
              </ul>
            ...
            <div className="rounded-xl border border-amber-100 bg-amber-50/50 px-5 py-5">
              ...
              <p className="text-[17px] text-stone-500 leading-relaxed italic">
                [What families don&rsquo;t know -- add in Prompt 7]
              </p>
            </div>
            ...
            <div className="rounded-xl border border-stone-100 bg-white px-5 py-5">
              ...
              <p className="text-[17px] text-stone-500 leading-relaxed italic">
                [Secondary pathway -- add in Prompt 7]
              </p>
            </div>
